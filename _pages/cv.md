...
* **Ph.D. Researcher**, National University of Singapore, 2024–present  
  * Research on high-performance memory devices, including BEOL-compatible oxide-semiconductor FeFETs, dual-gate FeFETs, and 3D Fe-VNAND architectures.

* **Undergraduate Research Assistant**, Shandong University, 2021–2024  
  * Conducted first-principles and quantum-transport simulations for high-performance tunnel field-effect transistors.
  * Used QuantumATK and Python-based high-throughput screening for material and device analysis.
...
Dong Zhang, ***Xinming Li***, Xiaopeng Li, Zijie Zheng, Chen Sun, Yang Feng, Yuxuan Wang, Zuopu Zhou, Gan Liu, Xiaolin Wang, Jiezhi Chen, Xiao Gong  
...
Chen Sun, ***Xinming Li***, Dong Zhang, Wei Shi, Yue Chen, Gan Liu, Rui Shao, Qiwen Kong, Yuxuan Wang, Leming Jiao, Zuopu Zhou, Yang Feng, Xiaolin Wang, Kai Ni, Xiao Gong  
*IEEE International Electron Devices Meeting (IEDM)*, 2025  

[A Generalizable Tri-Layer Design Framework for Enhancing OSFET Reliability](https://ieeexplore.ieee.org/document/11074814)  
...
[Toward Nanoscale Organic Tunnel Field-Effect Transistors with Small Subthreshold Swing and High On-State Current: A Computational Design Based on Two-Dimensional Covalent-Organic Frameworks](https://doi.org/10.1021/acsanm.3c03366)  
***Xinming Li***, Yuan Li  
...
* National First Prize **(Top 0.2%)**, National College Students' Mathematical Modeling Competition, 2022
